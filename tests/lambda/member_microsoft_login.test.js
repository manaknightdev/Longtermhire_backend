...
class MicrosoftLoginTests {
  ...
  setupTests() {
    this.framework.describe("member Microsoft Login API Tests", () => {
      let mockAccessToken;
      ...
      this.framework.addTestCase("member Microsoft Login URL - Success Path", async () => {
        ...
        this.framework.mockRequest(
          `${BASE_URL}/v2/api/lambda/microsoft/login?role=member`,
      ...
      this.framework.addTestCase("member Microsoft Code API - Success Path", async () => {
        // Mock the API response
        this.framework.mockRequest(
      ...
      this.framework.addTestCase("member Microsoft Code API - Error Path", async () => {
      ...
      this.framework.addTestCase("member Microsoft Mobile Login - Success Path", async () => {
        // Mock the API response
        this.framework.mockRequest(
      ...
      this.framework.addTestCase("member Microsoft Mobile Login - Error Path", async () => {
        // Mock the API response for error case
        this.framework.mockRequest(
          `${BASE_URL}/v2/api/lambda/microsoft/login/mobile`,
          {
