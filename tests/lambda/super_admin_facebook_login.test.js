...
class FacebookLoginTests {
  ...
  setupTests() {
    this.framework.describe("super_admin Facebook Login API Tests", () => {
      let mockAccessToken;
      ...
      this.framework.addTestCase(
        "super_admin Facebook Login URL - Success Path",
        async () => {
          ...
          this.framework.mockRequest(
            `${BASE_URL}/v2/api/lambda/facebook/login?role=super_admin`,
      ...
      this.framework.addTestCase(
        "super_admin Facebook Code API - Success Path",
        async () => {
          // Mock the API response
          this.framework.mockRequest(
      ...
      this.framework.addTestCase(
        "super_admin Facebook Code API - Error Path",
        async () => {
      ...
      this.framework.addTestCase(
        "super_admin Facebook Mobile Login - Success Path",
        async () => {
          // Mock the API response
          this.framework.mockRequest(
      ...
      this.framework.addTestCase(
        "super_admin Facebook Mobile Login - Error Path",
        async () => {
          // Mock the API response for error case
          this.framework.mockRequest(
            `${BASE_URL}/v2/api/lambda/facebook/login/mobile`,
