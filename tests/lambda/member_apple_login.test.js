...
class AppleLoginTests {
  ...
  setupTests() {
    this.framework.describe("member Apple Login API Tests", () => {
      ...
      this.framework.addTestCase(
        "member Apple Login Mobile - Success Path",
        async () => {
      ...
      this.framework.addTestCase(
        "member Apple Login Mobile - Invalid Identity",
        async () => {
      ...
      this.framework.addTestCase(
        "member Apple Login URL - Success Path",
        async () => {
          // Mock the API response
          this.framework.mockRequest(
            `${this.baseUrl}/v2/api/lambda/apple/login?role=member`,
      ...
      this.framework.addTestCase(
        "member Apple Code API - Success Path",
        async () => {
          // Mock the API response
          this.framework.mockRequest(
