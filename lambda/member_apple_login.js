...
module.exports = function (app) {
  ...
  app.get("/v1/api/longtermhire/member/lambda/apple/login", middlewares, async function (req, res) {
    try {
      ...
      const options = {
        ...
        state: "longtermhire" + "~" + req.query.role ?? "member" + "~" + hostname + companyState,
  ...
  app.post("/v1/api/longtermhire/member/lambda/apple/code", async function (req, res) {
