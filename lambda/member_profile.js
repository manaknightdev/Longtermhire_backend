...
module.exports = function (app) {
  app.get("/v1/api/longtermhire/member/lambda/profile", middlewares, async (req, res) => {
    await handleGetProfile(req, res, app.get("sdk"));
  });

  app.post("/v1/api/longtermhire/member/lambda/profile", middlewares, async (req, res) => {
