...
module.exports = function (app) {
  ...
  app.get("/v1/api/longtermhire/super_admin/lambda/google/code/mobile", async function (req, res) {
  ...
  app.get("/v1/api/longtermhire/super_admin/lambda/google/login", async function (req, res) {
    const Role = require(`../roles/super_admin`);
    if (!Role.permissions.canGoogleLogin) {
      return res.status(403).json({
        error: true,
